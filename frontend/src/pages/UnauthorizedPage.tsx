...
import { ROLE_LABEL, getRoleHomeRoute, pickActiveRole } from "../lib/roles";
  ...
  return (
    <main className="mx-auto max-w-lg px-6 py-20 font-sans text-ink">
      ...
      <p className="mt-3 text-[15px] text-mute">
        You are signed in, but your authorized <code className="font-mono">roles[]</code> do not include this
        workspace. Changing the URL cannot grant access. Use the sidebar <strong>Workspace</strong> switcher for roles
        you already have.
      </p>
      {profile && (
        <ul className="mt-4 font-mono text-[12px] text-mute">
          ...
          <li>activeRole (workspace only): {ROLE_LABEL[profile.activeRole]}</li>
        </ul>
      )}
      {!hasRoles && (
